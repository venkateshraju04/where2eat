      ...
      <main className="mx-auto max-w-2xl px-5 py-12">
        {success ? (
          ...
          <div className="space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-card">
              {error && (
              ...
              <div className="space-y-2">
                <label htmlFor="price" className="text-sm font-medium">Approx Price for Two (₹)</label>
                <input
                  id="price"
                  type="number"
              ...
              <div className="space-y-2">
                <label htmlFor="description" className="text-sm font-medium">Why do you recommend it?</label>
                <textarea
                  id="description"
                  rows={3}
              ...
              <div className="space-y-2">
                <label htmlFor="gmaps" className="text-sm font-medium">Google Maps Link</label>
                <input
                  id="gmaps"
                  type="url"
              ...
              <div className="space-y-2 pt-4 border-t border-border">
                <label htmlFor="submitter" className="text-sm font-medium">Your Name / Instagram (Optional)</label>
                <input
                  id="submitter"
